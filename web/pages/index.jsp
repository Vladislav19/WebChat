    ...
    <sec:authorize access="isAuthenticated()">
      ...
      <sec:authorize access="hasRole('CLIENT')">
        <p>
          ...
          <a class="btn btn-lg btn-success" href="<c:url value="/reg" />" role="button">Зарегистрироваться</a>
          <a class="btn btn-lg btn-success" href="<c:url value="/chatClient" />" onclick="doAjax()" role="button">Начать чат</a>
        </p>
      </sec:authorize>
      ...
      <sec:authorize access="hasRole('AGENT')">
        <p>
          <a class="btn btn-lg btn-danger" href="<c:url value="/logout" />" role="button">Выйти</a>
          <a class="btn btn-lg btn-success" href="<c:url value="/reg" />" role="button">Зарегистрироваться</a>
          <a class="btn btn-lg btn-success" href="<c:url value="/chatAgent" />" onclick="doAjax()" role="button">Начать чат</a>
        </p>
      </sec:authorize>
